...
// 4. Sonucun Java kelimesini icerdigini test edin
    ...
    // Element dropdown menu oldugu icin Select classindan olusturacagimiz
    // obje ile ilgili methodlari kullanmaliyiz
        ...
        int expectedOptinSayisi = 45;
        int actualOptionSayisi = select.getOptions().size();

        Assert.assertEquals(expectedOptinSayisi,actualOptionSayisi);
    }
    @Test
    public void test02(){
        WebElement dropDownMenuElementi = driver.findElement(By.xpath("//select[@id='searchDropdownBox']"));
